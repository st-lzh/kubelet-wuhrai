module github.com/st-lzh/kubelet-wuhrai
...
replace github.com/st-lzh/kubelet-wuhrai/gollm => ./gollm
...
require (
	...
	github.com/st-lzh/kubelet-wuhrai/gollm v0.0.0-00010101000000-000000000000
